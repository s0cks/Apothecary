...
import io.github.asyncronous.apothecary.client.model.ModelPot
...
with ISimpleBlockRenderingHandler{
  ...
  private val texture: ResourceLocation = new ResourceLocation("apot", "textures/blocks/pot.png");
  ...
  override def renderTileEntityAt(tiles: TileEntity, x: Double, y: Double, z: Double, scale: Float): Unit ={
    ...
    if(tile.isFilled()){
      ...
      this.renderIcon(0, 0, Blocks.water.getIcon(0, 0), 16, 16, 240);
